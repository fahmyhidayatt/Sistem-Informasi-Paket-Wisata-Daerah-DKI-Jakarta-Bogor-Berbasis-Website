						...
						<div class="container">
							<div class="row">
				                <div class="col-xs-12 text-center">
				                  ...
				                  <span class="section-sub">Lisa Tour& Travel</span>
				                </div>
			             	 </div>
			             	 ...
			             	 <div class="team-members">
			             	 	<div class="row">
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/khalil.jpg" alt="zoom">
									            </a>
									        </div>

											<div class="member-info">
										        <h3>KHALIL AYESH KHALIL
										            <small>Owner</small>
										        </h3>
											</div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/ali.jpg" alt="Image">
									            </a>
									        </div>

											<div class="member-info">
										        <h3>ABDUL ALI ROBAI
										            <small>Manager Ticketing</small>
										        </h3>
											</div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/fahmy.jpg" alt="Image">
									            </a>
									        </div>

											<div class="member-info">
										        <h3>FAHMY HIDAYAT
										            <small>Agent Ticketing</small>
										        </h3>
											</div>
								...
								<div class="row">
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/dedi.jpg" alt="Image">
									            </a>
									        </div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/lina.jpg" alt="Image">
									          </a>
									        </div>
									...
									<div class="col-sm-4 col-xs-12">
									    <figure class="team-member">
									        <div class="member-thumbnail">
									            <img src="img/team/rani.jpg" alt="Image">
									           </a>
									        </div>
