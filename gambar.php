                                         ...
                                         <div class="blog-post-overlay"></div>
                                            <div class="figure">    
                                                <div id="blog-post-carousel" class="carousel slide blog-carousel" data-ride="carousel">
                                                  ...
                                                  <a class="img-link" href="admin/admin/pages/wj/<?php echo $data['gambar']; ?>"  width="50" heigth="50"><small><img src="admin/admin/pages/wj/<?php echo $data['gambar']; ?>" width="50" heigth="50" alt="zoom"></small></a>
                                                </div>
