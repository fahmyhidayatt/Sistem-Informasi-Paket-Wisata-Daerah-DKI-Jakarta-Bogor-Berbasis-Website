                            ...
                            <div class="container mainnav">
                                ...
                                <div class="collapse navbar-collapse navbar-collapse">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        <!-- Home -->
                                        <li><a href="tourp.php">Kembali</a></li>
                                    </ul>
                                </div><!-- /.navbar-collapse -->
                            </div><!-- /.container -->
    ...
    <div class="container">
            <div>
                <h1><center> FORM BOOKING TOUR </center></h1>
             <center>   <h2> (Lisa Tour& Travel)</h2> <center>
                <br/>
                <br/>
...
<form method="post" action="input_pesan.php" enctype="multipart/form-data">
    <table>
        <tr>
            <td>
    <div class="form-grup">
