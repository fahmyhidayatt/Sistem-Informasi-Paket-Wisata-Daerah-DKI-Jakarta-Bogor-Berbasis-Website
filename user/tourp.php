                                ...
                                <div class="col-xs-12">
                                    <div class="page-header-wrap">
                                       ...
                                       <ol class="breadcrumb">
                                          ...
                                          <li class="active">DKI Jakarta / Bogor</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <article class="blog-post-wrapper">
                                            ...
                                            <div class="figure">    
                                                ...
                                                <div class="post-thumbnail">
                                                    <img src="img/tourpac/jakarta.jpg" class="img-responsive " alt="">
                                                    <div class="blog-post-overlay"></div>
                                                    <a class="img-link" href="img/tourpac/jakarta.jpg"><small>
                                                        <img src="img/zoomin.png" alt="zoom"></small>
                                                    </a>    
                                                </div>
                                            ...
                                            <p>The following details the package offered by Lisa Tour & Travel: </p>
                                                        <p> 1. DKI Jakarta. </p>
                                                        <p> Prices for individuals:</p>
                                                      <p>  Rp.2,000,000/ person 3D2N </p>
                                                       <p> Rp.2,500,000 / person  4D3N. </p>
                                                       <p> Price for grouping (min 12 people):</p>
                                                  <p> Rp.1,500,000 / person 3D2N </p>
                                                  <p>  Rp.2,200,000 / person 4D3N. </p>
                                            ...
                                            <footer class="entry-footer"> 
                                                 ...
                                                 <a href="cekfasilitas.php" class="btn btn-primary btn-sm readmore">Check Facilities</a>
                                            </footer>
                                        ...
                                        <article class="blog-post-wrapper">
                                                ...
                                                <div id="blog-post-carousel" class="carousel slide blog-carousel" data-ride="carousel">
                                                    ...
                                                    <div class="carousel-inner">
                                                        <div class="item active">
                                                            <div class="post-thumbnail">
                                                                <img class="img-responsive" src="img/tourpac/bogor.jpg" alt=""/>

                                                                <div class="blog-post-overlay"></div>
                                                    <a class="img-link" href="img/tourpac/bogor.jpg">
                                                        <small><img src="img/zoomin.png" alt="zoom"></small>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="entry-content">
                                                <p>The following details the package offered by Lisa Tour & Travel: </p>
                                                    <p> 2. Bogor. </p>
                                                    <p> Prices for individuals:</p>
                                                      <p>  Rp.1,700,000/ person 3D2N </p>
                                                       <p> Rp.3,000,000 / person  4D3N. </p>
                                                   <p> Price for grouping (min 12 people):</p>
                                                 <p> Rp.1,500,000 / person 3D2N </p>
                                                 <p>   Rp. 2,700,000 / person 4D3N. </p>
                                            </div><!-- .entry-content -->
                                            <footer class="entry-footer"> 
                                                 <a href="cekfasilitasb.php" class="btn btn-primary btn-sm readmore">Check Facilities</a>
                                                    <br>
                                                    <br>
                                                    <br>


                                                   <center>  <a href="booktour.php" class="btn btn-primary btn-sm readmore">Booking Now</a>
                                                        </center>
                                            </footer>
