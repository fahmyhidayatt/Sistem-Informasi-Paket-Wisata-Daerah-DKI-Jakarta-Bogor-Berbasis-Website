                                ...
                                <div class="posts-container">
                                    <div class="col-md-8 col-sm-8">
                                         <article class="blog-post-wrapper">
                                            ...
                                            $query = "SELECT * FROM td_wisatabr ORDER BY kdwisata DESC";
                                         ...
                                         <div class="blog-post-overlay"></div>
                                            <div class="figure">    
                                                <div id="blog-post-carousel" class="carousel slide blog-carousel" data-ride="carousel">
                                                    ...
                                                    <div class="blog-post-overlay" class="img-responsive"></div>
                                                  <a class="img-link" href="admin/admin/pages/wb/<?php echo $data['gambar']; ?>"  width="50" heigth="50"><small><img src="admin/admin/pages/wb/<?php echo $data['gambar']; ?>" width="50" heigth="50" alt="zoom"></small></a>
                                                </div>
                                            ...
                                            <header class="entry-header clearfix">
                                                <aside>
                                                    <div class="posted-date pull-left">
                                                       <span><?php echo $data['tgl_upload'] ?></span>
                                                    </div>  
