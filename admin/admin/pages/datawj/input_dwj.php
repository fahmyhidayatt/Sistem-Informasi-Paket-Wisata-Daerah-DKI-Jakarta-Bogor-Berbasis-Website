        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">INPUT WISATA</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
TAMBAH DATA DKI JAKARTA
    ...
    <?php
                        ...
                        if (isset($_POST['simpan'])) {
                            ...
                            move_uploaded_file($pndah,'wj/'.$namef);
                            $insert = mysqli_query($koneksi, "INSERT INTO td_wisata (gambar,judul,isi) VALUES ('$namef','$nama','$lokasi')");
                            if($insert){
                                echo '<script>alert("Berhasil Menginput Data, Cek Info");window.location =("?module=datawj/dtwj") </script>';
                            }else{
                                echo '<script>alert("Maaf Anda Tidak Mengisi Dengan Benar");window.location =("?module=datawj/input_dtwj") </script>';
                            }
