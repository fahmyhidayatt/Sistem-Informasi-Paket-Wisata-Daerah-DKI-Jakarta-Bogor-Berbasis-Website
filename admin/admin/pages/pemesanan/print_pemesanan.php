...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM td_booking where kdbooking='$_GET[id]'"));
?>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center>Tour Package</h3></td>
</tr> 
<tr>
