...
<title>Print Penyewaan Motor</title>
...
include "koneksi.php"; 
include "tglindo.php"; 
$d = mysqli_fetch_array(mysqli_query($koneksi, "SELECT * FROM td_bkmr where kdsewa ='$_GET[id]'"));
?>
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center>Rental Motorcycle</h3></td>
</tr> 
<tr>
