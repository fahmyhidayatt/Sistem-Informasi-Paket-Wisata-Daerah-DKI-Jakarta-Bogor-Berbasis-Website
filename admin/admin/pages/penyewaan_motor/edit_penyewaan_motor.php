...
include"koneksi.php";
$id=$_GET['id'];
$edit=mysqli_query($koneksi, "SELECT * from td_bkmr WHERE kdsewa ='$id'");
$book = mysqli_fetch_array($edit);

$namak    = array('HONDA PCX', 'YAMAHA NMX' , 'HONDA SCOOPY');
...
Edit Penyewaan Motor
 	  ...
 	  <form method="post" action="?module=penyewaan_motor/proses_penyewaan">
