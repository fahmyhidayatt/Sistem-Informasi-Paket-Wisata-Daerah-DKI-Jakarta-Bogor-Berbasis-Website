...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi, "SELECT * from td_makakhas WHERE kdmakakhas='$e'");
...
<div class="form-group">
    <img src="mkj/<?php echo $book['gambar']?>" width="200">
</div>
<div class="form-group">
    <label>Ganti Gambar</label>
    <input type="file" name="gambar" class="form-control" value="<?php echo $book['gambar'];?>">
</div>
<div>    
...
<a  href="index.php?module=datamkj/dtmkj" >Kembali</a>
</form>
...
if (isset($_POST['simpan']))
{
    ...
    if (!empty($lokasifoto))
    {
        move_uploaded_file($lokasifoto,"mkj/$namafoto");
        $koneksi->query("UPDATE td_makakhas SET file='$namafoto',judul='$jd',isi='$isi'
            WHERE kdmakakhas='$_GET[id]'");
            }
else
            {
        $koneksi->query("UPDATE td_makakhas SET judul='$jd',isi='$isi' WHERE kdmakakhas='$_GET[id]'");
            }
            echo "<script>alert('data telah dirubah');</script>";
            echo "<script>location='index.php?module=datamkj/dtmkj';</script>";
            } 
