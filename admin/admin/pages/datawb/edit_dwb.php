...
include"koneksi.php";
$e=$_GET['id'];
$edit=mysqli_query($koneksi, "SELECT * from td_wisatabr WHERE kdwisata='$e'");
...
<div class="form-group">
    <img src="wb/<?php echo $book['gambar']?>" width="200">
</div>
<div class="form-group">
...
<a  href="index.php?module=datawb/dtwb" >Kembali</a>
</form>
...
if (isset($_POST['simpan']))
{
    ...
    if (!empty($lokasifoto))
    {
        move_uploaded_file($lokasifoto,"wb/$namafoto");
        $koneksi->query("UPDATE td_wisatabr SET file='$namafoto',judul='$jd',isi='$isi'
            WHERE kdwisata='$_GET[id]'");
            }
else
            {
        $koneksi->query("UPDATE td_wisatabr SET judul='$jd',isi='$isi' WHERE kdwisata='$_GET[id]'");
            }
            echo "<script>alert('data telah dirubah');</script>";
            echo "<script>location='index.php?module=datawb/dtwb';</script>";
            } 
