...
TAMBAH DATA BOGOR
    ...
    <?php
                        ...
                        if (isset($_POST['simpan'])) {
                            ...
                            move_uploaded_file($pndah,'wb/'.$namef);
                            $insert = mysqli_query($koneksi, "INSERT INTO td_wisatabr (gambar,judul,isi) VALUES ('$namef','$nama','$lokasi')");
                            if($insert){
                                echo '<script>alert("Berhasil Menginput Data, Cek Info");window.location =("?module=datawb/dtwb") </script>';
                            }else{
                                echo '<script>alert("Maaf Anda Tidak Mengisi Dengan Benar");window.location =("?module=datawb/input_dtwb") </script>';
                            }
