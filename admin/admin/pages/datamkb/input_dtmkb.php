...
TAMBAH DATA MAKANAN KHAS BOGOR
	</div>
    ...
    <?php
                        ...
                        if (isset($_POST['simpan'])) {
                            ...
                            move_uploaded_file($pndah,'mkb/'.$namef);
                            $insert = mysqli_query($koneksi, "INSERT INTO td_makakhasbr (gambar,judul,isi) VALUES ('$namef','$nama','$lokasi')");
                            if($insert){
                                echo '<script>alert("Berhasil Menginput Data, Cek Info");window.location =("?module=datamkb/dtmkb") </script>';
                            }else{
                                echo '<script>alert("Maaf Anda Tidak Mengisi Dengan Benar");window.location =("?module=datamkb/input_dtmkb") </script>';
                            }
