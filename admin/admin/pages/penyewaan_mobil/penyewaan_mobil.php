...
include"koneksi.php";
$no = 1;
$qry_pas = mysqli_query($koneksi, "SELECT * from td_bkml");
...
<b>DATA PENYEWAAN MOBIL </b>
</div>
<a href="?module=penyewaan_mobil/input_penyewaan_mobil" class="btn btn-success" style="margin-top:20px;"><span class="glyphicon glyphicon-plus"> TAMBAH DATA</span></a>
<?php
@$aksi = $_GET['aksi'];
if($aksi=="input")
{
	include("?module=penyewaan_mobil/input_penyewaan_mobil");
}
?>
<div class="th">
<table class="table table-bordered" style="margin-top:20px;">
	...
	$query = "SELECT * FROM td_bkml ORDER BY kdsewa DESC";
	...
	<tr>
	 ...
	 <td>
	 	<a href="?module=penyewaan_mobil/edit_penyewaan_mobil&id=<?php echo $data['kdsewa']; ?>">
	 	<span class="glyphicon glyphicon-pencil"></span></a></td><td>
	 	<a href="?module=penyewaan_mobil/hapus_penyewaan_mobil&id=<?php echo $data['kdsewa']; ?>" onclick="return confirm('Delete?');">
	 		<span class="glyphicon glyphicon-trash"></span></a></td><td>
	 	<a href="?module=penyewaan_mobil/print_penyewaan_mobil&id=<?php echo $data['kdsewa']; ?>" target="_blank">
