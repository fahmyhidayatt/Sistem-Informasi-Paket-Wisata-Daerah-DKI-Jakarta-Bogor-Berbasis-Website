        ...
        <div id="st-container" class="st-container">
            <div class="st-pusher">
                <div class="st-content">
                                ...
                                <div class="col-xs-12">
                                    <div class="page-header-wrap">
                                        <div class="page-header">
                                            <h1>Tour Package / Rental </h1>
                                        </div>
                                       <ol class="breadcrumb">
                                          <li class="active"> You Need Login </li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                    ...
                    <p><center>You want to book a tour package and rent a vehicle, please login first, register yourself right now because there are many tour packages to get to Jakarta and Bogor,thanks you.</center> </p>




                        <p><center><a href="login.php" class="btn btn-primary btn-sm readmore">LOGIN</a></center></p>
